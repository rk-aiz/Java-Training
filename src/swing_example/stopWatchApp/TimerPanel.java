...
public class TimerPanel extends JPanel {
	...
	private Duration targetDuration = Duration.ofSeconds(300L);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TimerPanel frame = new TimerPanel();
	...
	public TimerPanel() {
		...
		swControlPanel.add(increaseButton);
		...
		swControlPanel.add(decreaseButton);
